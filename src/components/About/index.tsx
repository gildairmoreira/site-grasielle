        ...
        <div className="flex flex-col w-full md:w-1/2">
          <span className="flex mb-8">
            <Image
              ...
              height={3}
            />
            <h3 className="font-dmtext text-xl uppercase text-dark__text-200 ml-4 md:ml-12">
              O Escritório
            </h3>
          </span>
          <h2 className="font-dmtext text-4xl md:text-6xl text-gold__principal-100 mb-8">
            Sobre
          </h2>
          <div className="flex flex-col w-full md:w-[90%] font-sans font-medium text-xl text-dark__text-100">
            ...
            <p className="mb-4">
              ...
              Membro das comissões de Direito e Tecnologia e Marketing Jurídico
              da OAB
            </p>
            <p>
              ...
              empresarial. Adaptamos nossos serviços às necessidades específicas
              de cada cliente.
            </p>
          </div>
