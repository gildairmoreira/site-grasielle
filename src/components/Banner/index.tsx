...
export function Banner() {
  return (
    <section
      className="w-full h-screen flex items-center bg-inherit md:bg-cover relative"
      style={{ backgroundImage: "url('/images/banner-fundo.png')" }}
    >
      {/* Parte esquerda com títulos */}
      <div className="w-full lg:w-1/2 h-[80vh] flex justify-center flex-col ml-8 p-2 md:p-9 ">
        ...
        <p className="font-sans text-lg md:text-xl text-gray-300 my-6">
        ...
        <a
          ...
          target="_blank"
          className="btn-default w-4/5 md:w-2/3 lg:w-2/5 bg-gold__principal-300 hover:bg-gold__principal-400 font-sans font-bold text-white text-center py-2 px-4"
        >
          Contatar
        </a>
      </div>
